...
import { GameType, GameVariant } from '@/lib/gql/graphql';
...
export function CreateInstanceDialog({ open, onOpenChange }: { open: boolean; onOpenChange: (open: boolean) => void }) {
	...
	const [runtimeVersion, setRuntimeVersion] = useState('21');
					...
					<>
						...
						<DialogFooter>
							...
							<Button
								...
								disabled={!name.trim() || !variantVersion || creating}
							>
