...
export type GetGamesQuery = { __typename?: 'Query', getGames: Array<{ __typename?: 'GameInfoDto', name: string, developer: string, icon: string, developerIcon: string, type: GameType, supportedPlatforms: Array<string> }> };
